<?php 
	...
	$itungcust = mysqli_query($conn,"select count(userid) as jumlahcust from anggota where role='Member'");
	$itungcust2 = mysqli_fetch_assoc($itungcust);
	$itungcust3 = $itungcust2['jumlahcust'];
	
	$itungorder = mysqli_query($conn,"select count(idcart) as jumlahorder from pesanan where status not like 'Selesai' and status not like 'Canceled'");
						...
						<div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Konfirmasi Pembelian</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
