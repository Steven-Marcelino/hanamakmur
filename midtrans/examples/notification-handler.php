...
$email_user = $notif->email;
$id_user = $notif->id_user;
$kategori_payment = $notif->kategori_payment;
$nama_kategori = $notif->nama_kategori;
$jumlah_order = $notif->jumlah_order;
$biaya = $notif->biaya;
$total_biaya = $notif->total_biaya;
$fraud = $notif->fraud_status;

if ($transaction == 'settlement') {

    include "../../dbconnect.php";
    mysqli_query($conn, "update payment set transaction_status='3' , transaction_id='$transaction_id' where order_id='$order_id'");


} else if ($transaction == 'pending') {
    include "../../dbconnect.php";
    mysqli_query($conn, "update payment set transaction_status='2' where order_id='$order_id'");

} else if ($transaction == 'deny') {
    include "../../dbconnect.php";
    mysqli_query($conn, "update payment set transaction_status='1' where order_id='$order_id'");
