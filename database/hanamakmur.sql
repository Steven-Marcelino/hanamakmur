...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Agu 2023 pada 18.52
...
(16, 'steven', 'stevenmarcelino951@gmail.com', '$2y$10$mMWl8oViNiZRaqfc7SgEseU12X8srStLEM97jLIrIb2d0hpjfODS.', '23489', 'Lingkungan V. Rt 023 Rw 009.', '2023-08-29 15:46:15', 'Member');
...
(129, '16dyrYMr21NEA', 24, 1),
(130, '16dyrYMr21NEA', 24, 1),
(131, '166Kr6Lfs3reY', 24, 1),
(132, '166Kr6Lfs3reY', 24, 1),
(133, '166Kr6Lfs3reY', 24, 1);
...
INSERT INTO `payment` (`id`, `nama`, `alamat`, `biaya`, `email`, `order_id`, `transaction_status`, `transaction_id`) VALUES
(22, 'steven', 'Lingkungan V. Rt 023 Rw 009.', 25000, 'stevenmarcelino951@gmail.com', '336947880', '1', '');
...
(69, '166Kr6Lfs3reY', 16, 0, '2023-08-29', 'Cart');
...
--
ALTER TABLE `detail_pesanan`
  MODIFY `detailid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
