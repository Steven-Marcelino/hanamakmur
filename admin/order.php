...
$liatcust = mysqli_query($conn,"select * from anggota l, pinjam c where orderid='$orderids' and l.userid=c.userid");
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                <a href="manageorder.php"><i class="ti-dashboard"></i><span>Kelola Pemesanan</span></a>
                            </li>
							<li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h3>ID Pesanan : #<?php echo $orderids ?></h3>
									
								</div>
                                   <p><?php echo $checkdb['namalengkap']; ?> (<?php echo $checkdb['alamat']; ?>)</p>
								<p>Waktu pesanan : <?php echo $checkdb['tglpinjam']; ?></p>
								   ...
								   <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from detail_pinjam d, produk p where orderid='$orderids' and d.idproduk=p.idproduk order by d.idproduk ASC ");
											$no=1;
