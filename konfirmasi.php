...
if (isset($_POST['confirm'])) {
	...
	$userid = $_SESSION['id'];
	$veriforderid = mysqli_query($conn, "select * from pesanan where orderid='$idorder'");
	...
	if ($fetch > 0) {
		...
		$kon = mysqli_query($conn, "insert into konfirmasi (orderid, userid, namapeminjam, tglpesanan) 
		values('$idorder','$userid','$nama','$tanggal')");
		if ($kon) {

			$up = mysqli_query($conn, "update pesanan set status='Confirmed' where orderid='$idorder'");
